...
const Dashboard = ({ rulesCount, stats, language = "vi" }) => {
  ...
  return (
    <div id="dashboard-container" className="max-w-4xl space-y-12 animate-in fade-in duration-500">
      <header>
      ...
      <div id="dashboard-stats-cards" className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center">
      ...
      <div id="dashboard-chart-container" className="bg-white p-12 rounded-[56px] border border-slate-100 flex flex-col items-center justify-center text-center py-20 shadow-sm">
